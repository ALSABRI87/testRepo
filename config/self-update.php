...
return [
    ...
    */
    ...
    'version_installed' => env('SELF_UPDATER_VERSION_INSTALLED', 'v.1.0'),
    ...
    */
    ...
    'repository_types' => [
        'github' => [
            'type'                 => 'github',
            'repository_vendor'    => env('SELF_UPDATER_REPO_VENDOR', 'ALSABRI87'),
            'repository_name'      => env('SELF_UPDATER_REPO_NAME', 'testRepo'),
            'repository_url'       => '',
